...
class LeafSubmissionState extends State<LeafSubmission> {
  ...
  getUserDetailsStream() async {
    ...
    if (currentUser != null) {
      ...
      userStream = await DatabaseMethods().getUserDetails(userId!);
      setState(() {});
    }
  }
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => UserDetailScreen(userDetails: userDetails),
                    ),
                  );
                },
                child: ListTile(
                  ...
                  trailing: Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () async {
                          await DatabaseMethods().deleteUserDetails(userDetails["id"]);
                        },
                      ),
                    ],
                  ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => const UserLeaf()));
        },
...
class UserDetailScreen extends StatelessWidget {
  ...
  const UserDetailScreen({Key? key, required this.userDetails}) : super(key: key);
