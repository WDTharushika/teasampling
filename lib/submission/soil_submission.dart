...
class SoilSubmissionState extends State<SoilSubmission> {
  ...
  getUserDetailsStream() async {
    ...
    if (currentUser != null) {
      ...
      userStream = await DatabaseMethods().getUserDetails(userId!, collection: 'Soil detail form');
      setState(() {});
    }
  }
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => UserSoilDetailScreen(userDetails: userDetails),
                    ),
                  );
                },
                child: ListTile(
                  ...
                  trailing: Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () async {
                          await DatabaseMethods().deleteUserDetails(userDetails["id"], collection: 'Soil detail form');
                        },
                      ),
                    ],
                  ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => const UserSoil()));
        },
...
class UserSoilDetailScreen extends StatelessWidget {
  ...
  const UserSoilDetailScreen({Key? key, required this.userDetails}) : super(key: key);
